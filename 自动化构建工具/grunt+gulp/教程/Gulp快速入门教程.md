...
* 使用gulp插件
  ...
  * 处理css
    ...
    * 配置编码
      ...
      //先执行lessTask再执行cssTask
      module.exports.default=gulp.series(lessTask,gulp.parallel(minifyjs,cssTask));
      ```
  ...
  * 处理html
    ...
    module.exports.default=gulp.series(lessTask,gulp.parallel(minifyjs,cssTask,htmlMinify));
        ```
      * 修改页面引入
        ```
